...
def visit_person_casia(person_folder, preprocessing_dir):
    ...
    for sequence_folder in sequence_folders:
        ...
        flow_output_dir = os.path.join(preprocessing_dir, 'flow', person, sequence)
        ...
        if settings.calculate_pose:
            ...
            pose_output_dir = os.path.join(preprocessing_dir, 'pose', person, sequence)
...
def preprocess_casia(only_example=False):
    ...
    images_dir = correct_path(settings.casia_images_dir)
    all_person_folders = list_person_folders(images_dir, dataset='CASIA')
    if only_example:
    ...
    for person_folder in tqdm(all_person_folders):
        ...
        preprocessing_dir = correct_path(settings.casia_preprocessing_dir)
        visit_person_casia(person_folder, preprocessing_dir)
